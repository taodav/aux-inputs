...
#SBATCH --error=/home/taodav/scratch/log/uncertainty/on-cnn-lstm-t15-%j-%n-%a.err
#SBATCH --output=/home/taodav/scratch/log/uncertainty/on-cnn-lstm-t15-%j-%n-%a.out
#SBATCH --gres=gpu:1
...
TO_RUN=$(sed -n "${LOWER_IDX},${UPPER_IDX}p" scripts/runs/runs_uf8_cnn_lstm_t15.txt)
echo "$TO_RUN"
